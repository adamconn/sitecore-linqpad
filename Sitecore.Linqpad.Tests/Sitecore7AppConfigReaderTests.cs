...
{
    [TestClass]
    public class Sitecore7AppConfigReaderTests
    {
        public TestContext TestContext { get; set; } //this needs to be named TestContext

        [TestMethod, TestCategory("Sitecore7AppConfigReader class")]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", "Data\\Sitecore7AppConfigReaderData.xml", "version", DataAccessMethod.Sequential)]
        public void IsSupportedVersion()
        {
            ...
            var reader = new Sitecore7AppConfigReader();
            Assert.AreEqual(isSupported, reader.IsSupportedVersion(version));
        }

        [TestMethod, TestCategory("Sitecore7AppConfigReader class")]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.XML", "Data\\Sitecore7AppConfigReaderData.xml", "webConFig", DataAccessMethod.Sequential)]
        public void Read()
        {
